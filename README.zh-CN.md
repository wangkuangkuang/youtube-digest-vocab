...
- 建立自己的生词本：选中任意单词、短语或句子即可查看释义，连同步双语原句和视频时间戳一起保存。
- 用掌握度标记复习生词，在新视频字幕中自动重现高亮，支持回听原句、朗读发音、CSV/Anki 导出和挖空自测。
...
5. 选中字幕，获取 AI 内容讲解。
6. 选中单词、短语或句子打开查词卡片，点击 **收藏到单词本**，连同步双语原句一起保存。
7. 在 **单词本** 中复习生词：设置掌握度、跳回原句、回听和朗读、运行 **自测** 挖空练习，或导出 CSV 和 Anki。
...
- 生词本：划词查义、连同步双语原句和时间戳保存词条、掌握度三档、重现高亮、回听、朗读、CSV/Anki 导出和挖空自测。
